...
public class HealthbarG : MonoBehaviour {
    ...
    [Tooltip("Minimum possible heath: (default is 0)")] public float minimumHealth = -20;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low health is less than or equal to this:")] public int lowHealth = -15; // miserable




    [Tooltip("High health is greater than or equal to this:")] public int highHealth = 15;

    // Maximum possible health:
    [Tooltip("Maximum possible heath: (default is 100)")] public float maximumHealth = 20;
